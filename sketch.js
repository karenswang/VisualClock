...
function draw() {
  // change background color based on daytime (7am - 5pm) or nighttime (6pm - 6am)
  if (hour()>6 && hour() < 18) {
    background(220);
  } else {
    background(32);
  ...
  fill(0);
  textSize(15);
  text("*Check back during daytime (7am - 5pm) or nighttime (6pm - 6am) for different background colors!", 10,20);
